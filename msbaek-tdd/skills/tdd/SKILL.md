...
2. 빈 테스트 클래스 생성 — 주석 언어와 빌드 파일 UTF-8 인코딩 명시는
   `../../references/code-comment-style.md`를 따른다
3. 산출물 커밋 1회 — 템플릿 문서 + 빈 테스트 클래스(+ 새로 만든 빌드 골격이 있으면 함께).
   메시지 형식·한글 안전 방식은 `../../references/commit-style.md`를 따른다
4. **"/tdd-plan 실행하세요"** 안내
